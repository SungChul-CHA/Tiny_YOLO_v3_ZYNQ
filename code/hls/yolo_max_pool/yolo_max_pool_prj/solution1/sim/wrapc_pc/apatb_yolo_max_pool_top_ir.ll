; ModuleID = '/home/tony/Desktop/yolo_2022/Tiny_YOLO_v3_ZYNQ/code/hls/yolo_max_pool/yolo_max_pool_prj/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_yolo_max_pool_top_ir(%"class.hls::stream<hls::axis<quad_fp_pack, 2, 5, 6>, 0>"* noalias nonnull dereferenceable(14) %inStream, %"class.hls::stream<hls::axis<quad_fp_pack, 2, 5, 6>, 0>"* noalias nonnull dereferenceable(14) %outStream, %"struct.ap_uint<9>"* nocapture readonly %output_h, %"struct.ap_uint<9>"* nocapture readonly %output_w, %"struct.ap_uint<9>"* nocapture readonly %input_h, %"struct.ap_uint<9>"* nocapture readonly %input_w, %"struct.ap_uint<4>"* nocapture readonly %input_fold_ch, %"struct.ap_uint<2>"* nocapture readonly %stride) local_unnamed_addr #0 {
entry:
  ...
  call void @apatb_yolo_max_pool_top_hw(i64* %inStream_copy.data, i8* %inStream_copy.keep, i8* %inStream_copy.strb, i2* %inStream_copy.user, i1* %inStream_copy.last, i5* %inStream_copy.id, i6* %inStream_copy.dest, i64* %outStream_copy.data, i8* %outStream_copy.keep, i8* %outStream_copy.strb, i2* %outStream_copy.user, i1* %outStream_copy.last, i5* %outStream_copy.id, i6* %outStream_copy.dest, %"struct.ap_uint<9>"* %output_h, %"struct.ap_uint<9>"* %output_w, %"struct.ap_uint<9>"* %input_h, %"struct.ap_uint<9>"* %input_w, %"struct.ap_uint<4>"* %input_fold_ch, %"struct.ap_uint<2>"* %stride)
...
entry:
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<hls::axis<quad_fp_pack, 2, 5, 6>, 0>.177"(i64* %_V_data_V, i8* %_V_keep_V, i8* %_V_strb_V, i2* %_V_user_V, i1* %_V_last_V, i5* %_V_id_V, i6* %_V_dest_V, %"class.hls::stream<hls::axis<quad_fp_pack, 2, 5, 6>, 0>"* %0)
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<hls::axis<quad_fp_pack, 2, 5, 6>, 0>.177"(i64* %_V_data_V1, i8* %_V_keep_V2, i8* %_V_strb_V3, i2* %_V_user_V4, i1* %_V_last_V5, i5* %_V_id_V6, i6* %_V_dest_V7, %"class.hls::stream<hls::axis<quad_fp_pack, 2, 5, 6>, 0>"* %1)
  ret void
}
...
copy:                                             ; preds = %entry
  call fastcc void @"streamcpy_hls.p0class.hls::stream<hls::axis<quad_fp_pack, 2, 5, 6>, 0>.172"(%"class.hls::stream<hls::axis<quad_fp_pack, 2, 5, 6>, 0>"* nonnull align 512 %0, i64* %_V_data_V, i8* %_V_keep_V, i8* %_V_strb_V, i2* %_V_user_V, i1* %_V_last_V, i5* %_V_id_V, i6* %_V_dest_V)
  br label %ret
...
; Function Attrs: argmemonly noinline
define internal fastcc void @"onebyonecpy_hls.p0class.hls::stream<hls::axis<quad_fp_pack, 2, 5, 6>, 0>.177"(i64* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="0.0" %_V_data_V, i8* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="0.1" %_V_keep_V, i8* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="0.2" %_V_strb_V, i2* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="0.3" %_V_user_V, i1* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="0.4" %_V_last_V, i5* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="0.5" %_V_id_V, i6* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="0.6" %_V_dest_V, %"class.hls::stream<hls::axis<quad_fp_pack, 2, 5, 6>, 0>"* noalias "fpga.caller.interfaces"="layout_transformed") unnamed_addr #3 {
entry:
  %1 = icmp eq %"class.hls::stream<hls::axis<quad_fp_pack, 2, 5, 6>, 0>"* %0, null
  %2 = or i1 false, %1
  br i1 %2, label %ret, label %copy
...
copy:                                             ; preds = %entry
  call fastcc void @"streamcpy_hls.p0class.hls::stream<hls::axis<quad_fp_pack, 2, 5, 6>, 0>.180"(i64* %_V_data_V, i8* %_V_keep_V, i8* %_V_strb_V, i2* %_V_user_V, i1* %_V_last_V, i5* %_V_id_V, i6* %_V_dest_V, %"class.hls::stream<hls::axis<quad_fp_pack, 2, 5, 6>, 0>"* nonnull %0)
  br label %ret
...
; Function Attrs: argmemonly noinline
define internal fastcc void @"streamcpy_hls.p0class.hls::stream<hls::axis<quad_fp_pack, 2, 5, 6>, 0>.180"(i64* noalias nocapture "fpga.caller.interfaces"="layout_transformed" "unpacked"="0.0" %_V_data_V, i8* noalias nocapture "fpga.caller.interfaces"="layout_transformed" "unpacked"="0.1" %_V_keep_V, i8* noalias nocapture "fpga.caller.interfaces"="layout_transformed" "unpacked"="0.2" %_V_strb_V, i2* noalias nocapture "fpga.caller.interfaces"="layout_transformed" "unpacked"="0.3" %_V_user_V, i1* noalias nocapture "fpga.caller.interfaces"="layout_transformed" "unpacked"="0.4" %_V_last_V, i5* noalias nocapture "fpga.caller.interfaces"="layout_transformed" "unpacked"="0.5" %_V_id_V, i6* noalias nocapture "fpga.caller.interfaces"="layout_transformed" "unpacked"="0.6" %_V_dest_V, %"class.hls::stream<hls::axis<quad_fp_pack, 2, 5, 6>, 0>"* noalias nocapture "fpga.caller.interfaces"="layout_transformed") unnamed_addr #4 {
entry:
  %1 = alloca %"class.hls::stream<hls::axis<quad_fp_pack, 2, 5, 6>, 0>"
...
declare void @apatb_yolo_max_pool_top_hw(i64*, i8*, i8*, i2*, i1*, i5*, i6*, i64*, i8*, i8*, i2*, i1*, i5*, i6*, %"struct.ap_uint<9>"*, %"struct.ap_uint<9>"*, %"struct.ap_uint<9>"*, %"struct.ap_uint<9>"*, %"struct.ap_uint<4>"*, %"struct.ap_uint<2>"*)
...
define void @yolo_max_pool_top_hw_stub_wrapper(i64*, i8*, i8*, i2*, i1*, i5*, i6*, i64*, i8*, i8*, i2*, i1*, i5*, i6*, %"struct.ap_uint<9>"*, %"struct.ap_uint<9>"*, %"struct.ap_uint<9>"*, %"struct.ap_uint<9>"*, %"struct.ap_uint<4>"*, %"struct.ap_uint<2>"*) #5 {
entry:
  %20 = alloca %"class.hls::stream<hls::axis<quad_fp_pack, 2, 5, 6>, 0>"
  %21 = alloca %"class.hls::stream<hls::axis<quad_fp_pack, 2, 5, 6>, 0>"
  call void @copy_out(%"class.hls::stream<hls::axis<quad_fp_pack, 2, 5, 6>, 0>"* %20, i64* %0, i8* %1, i8* %2, i2* %3, i1* %4, i5* %5, i6* %6, %"class.hls::stream<hls::axis<quad_fp_pack, 2, 5, 6>, 0>"* %21, i64* %7, i8* %8, i8* %9, i2* %10, i1* %11, i5* %12, i6* %13)
  call void @yolo_max_pool_top_hw_stub(%"class.hls::stream<hls::axis<quad_fp_pack, 2, 5, 6>, 0>"* %20, %"class.hls::stream<hls::axis<quad_fp_pack, 2, 5, 6>, 0>"* %21, %"struct.ap_uint<9>"* %14, %"struct.ap_uint<9>"* %15, %"struct.ap_uint<9>"* %16, %"struct.ap_uint<9>"* %17, %"struct.ap_uint<4>"* %18, %"struct.ap_uint<2>"* %19)
  call void @copy_in(%"class.hls::stream<hls::axis<quad_fp_pack, 2, 5, 6>, 0>"* %20, i64* %0, i8* %1, i8* %2, i2* %3, i1* %4, i5* %5, i6* %6, %"class.hls::stream<hls::axis<quad_fp_pack, 2, 5, 6>, 0>"* %21, i64* %7, i8* %8, i8* %9, i2* %10, i1* %11, i5* %12, i6* %13)
  ret void
}

declare void @yolo_max_pool_top_hw_stub(%"class.hls::stream<hls::axis<quad_fp_pack, 2, 5, 6>, 0>"*, %"class.hls::stream<hls::axis<quad_fp_pack, 2, 5, 6>, 0>"*, %"struct.ap_uint<9>"*, %"struct.ap_uint<9>"*, %"struct.ap_uint<9>"*, %"struct.ap_uint<9>"*, %"struct.ap_uint<4>"*, %"struct.ap_uint<2>"*)
