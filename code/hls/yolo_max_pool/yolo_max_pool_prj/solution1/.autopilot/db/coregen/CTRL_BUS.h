...
#define CTRL_BUS_ADDR_OUTPUT_H_DATA      0x10
#define CTRL_BUS_BITS_OUTPUT_H_DATA      9
#define CTRL_BUS_ADDR_OUTPUT_W_DATA      0x18
#define CTRL_BUS_BITS_OUTPUT_W_DATA      9
#define CTRL_BUS_ADDR_INPUT_H_DATA       0x20
#define CTRL_BUS_BITS_INPUT_H_DATA       9
#define CTRL_BUS_ADDR_INPUT_W_DATA       0x28
#define CTRL_BUS_BITS_INPUT_W_DATA       9
#define CTRL_BUS_ADDR_INPUT_FOLD_CH_DATA 0x30
#define CTRL_BUS_BITS_INPUT_FOLD_CH_DATA 4
#define CTRL_BUS_ADDR_STRIDE_DATA        0x38
#define CTRL_BUS_BITS_STRIDE_DATA        2
