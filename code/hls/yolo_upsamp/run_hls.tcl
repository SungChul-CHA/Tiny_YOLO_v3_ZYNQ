...
add_files src/yolo_upsamp.cpp -cflags -I${XF_PROJ_ROOT}/L1/include -csimflags -I${XF_PROJ_ROOT}/L1/include
add_files src/yolo_upsamp.h
add_files -tb tb/layer_input.dat
add_files -tb tb/layer_output_sdk.dat
add_files -tb tb/yolo_upsamp_tb.cpp -cflags -I${XF_PROJ_ROOT}/L1/include -csimflags -I${XF_PROJ_ROOT}/L1/include
