<AutoPilot:project xmlns:AutoPilot="com.autoesl.autopilot.project" top="yolo_upsamp_top" name="yolo_upsamp_prj">
    <includePaths/>
    <libraryFlag/>
    <files>
        <file name="../../tb/yolo_upsamp_tb.cpp" sc="0" tb="1" cflags=" -I/tools/Xilinx/Vitis_HLS/2022.2/include/vision/L1/include -Wno-unknown-pragmas" csimflags=" -Wno-unknown-pragmas" blackbox="false"/>
        ...
        <file name="src/yolo_upsamp.cpp" sc="0" tb="false" cflags="-I/tools/Xilinx/Vitis_HLS/2022.2/include/vision/L1/include" csimflags="" blackbox="false"/>
