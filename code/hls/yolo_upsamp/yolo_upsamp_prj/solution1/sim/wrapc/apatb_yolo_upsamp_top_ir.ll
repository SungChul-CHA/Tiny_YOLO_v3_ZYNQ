; ModuleID = '/home/tony/Desktop/yolo_2022/Tiny_YOLO_v3_ZYNQ/code/hls/yolo_upsamp/yolo_upsamp_prj/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_yolo_upsamp_top_ir(%"class.hls::stream<hls::axis<quad_fp_pack, 2, 5, 6>, 0>"* noalias nonnull dereferenceable(14) %inStream, %"class.hls::stream<hls::axis<quad_fp_pack, 2, 5, 6>, 0>"* noalias nonnull dereferenceable(14) %outStream) local_unnamed_addr #0 {
entry:
...
entry:
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<hls::axis<quad_fp_pack, 2, 5, 6>, 0>.12"(i64* %_V_data_V, i8* %_V_keep_V, i8* %_V_strb_V, i2* %_V_user_V, i1* %_V_last_V, i5* %_V_id_V, i6* %_V_dest_V, %"class.hls::stream<hls::axis<quad_fp_pack, 2, 5, 6>, 0>"* %0)
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<hls::axis<quad_fp_pack, 2, 5, 6>, 0>.12"(i64* %_V_data_V1, i8* %_V_keep_V2, i8* %_V_strb_V3, i2* %_V_user_V4, i1* %_V_last_V5, i5* %_V_id_V6, i6* %_V_dest_V7, %"class.hls::stream<hls::axis<quad_fp_pack, 2, 5, 6>, 0>"* %1)
  ret void
}
...
copy:                                             ; preds = %entry
  call fastcc void @"streamcpy_hls.p0class.hls::stream<hls::axis<quad_fp_pack, 2, 5, 6>, 0>.7"(%"class.hls::stream<hls::axis<quad_fp_pack, 2, 5, 6>, 0>"* nonnull align 512 %0, i64* %_V_data_V, i8* %_V_keep_V, i8* %_V_strb_V, i2* %_V_user_V, i1* %_V_last_V, i5* %_V_id_V, i6* %_V_dest_V)
  br label %ret
...
; Function Attrs: argmemonly noinline
define internal fastcc void @"onebyonecpy_hls.p0class.hls::stream<hls::axis<quad_fp_pack, 2, 5, 6>, 0>.12"(i64* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="0.0" %_V_data_V, i8* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="0.1" %_V_keep_V, i8* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="0.2" %_V_strb_V, i2* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="0.3" %_V_user_V, i1* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="0.4" %_V_last_V, i5* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="0.5" %_V_id_V, i6* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="0.6" %_V_dest_V, %"class.hls::stream<hls::axis<quad_fp_pack, 2, 5, 6>, 0>"* noalias "fpga.caller.interfaces"="layout_transformed") unnamed_addr #3 {
entry:
  %1 = icmp eq %"class.hls::stream<hls::axis<quad_fp_pack, 2, 5, 6>, 0>"* %0, null
  %2 = or i1 false, %1
  br i1 %2, label %ret, label %copy
...
copy:                                             ; preds = %entry
  call fastcc void @"streamcpy_hls.p0class.hls::stream<hls::axis<quad_fp_pack, 2, 5, 6>, 0>.15"(i64* %_V_data_V, i8* %_V_keep_V, i8* %_V_strb_V, i2* %_V_user_V, i1* %_V_last_V, i5* %_V_id_V, i6* %_V_dest_V, %"class.hls::stream<hls::axis<quad_fp_pack, 2, 5, 6>, 0>"* nonnull %0)
  br label %ret
...
; Function Attrs: argmemonly noinline
define internal fastcc void @"streamcpy_hls.p0class.hls::stream<hls::axis<quad_fp_pack, 2, 5, 6>, 0>.15"(i64* noalias nocapture "fpga.caller.interfaces"="layout_transformed" "unpacked"="0.0" %_V_data_V, i8* noalias nocapture "fpga.caller.interfaces"="layout_transformed" "unpacked"="0.1" %_V_keep_V, i8* noalias nocapture "fpga.caller.interfaces"="layout_transformed" "unpacked"="0.2" %_V_strb_V, i2* noalias nocapture "fpga.caller.interfaces"="layout_transformed" "unpacked"="0.3" %_V_user_V, i1* noalias nocapture "fpga.caller.interfaces"="layout_transformed" "unpacked"="0.4" %_V_last_V, i5* noalias nocapture "fpga.caller.interfaces"="layout_transformed" "unpacked"="0.5" %_V_id_V, i6* noalias nocapture "fpga.caller.interfaces"="layout_transformed" "unpacked"="0.6" %_V_dest_V, %"class.hls::stream<hls::axis<quad_fp_pack, 2, 5, 6>, 0>"* noalias nocapture "fpga.caller.interfaces"="layout_transformed") unnamed_addr #4 {
entry:
  %1 = alloca %"class.hls::stream<hls::axis<quad_fp_pack, 2, 5, 6>, 0>"
...
declare void @apatb_yolo_upsamp_top_hw(i64*, i8*, i8*, i2*, i1*, i5*, i6*, i64*, i8*, i8*, i2*, i1*, i5*, i6*)
...
define void @yolo_upsamp_top_hw_stub_wrapper(i64*, i8*, i8*, i2*, i1*, i5*, i6*, i64*, i8*, i8*, i2*, i1*, i5*, i6*) #5 {
entry:
  %14 = alloca %"class.hls::stream<hls::axis<quad_fp_pack, 2, 5, 6>, 0>"
  %15 = alloca %"class.hls::stream<hls::axis<quad_fp_pack, 2, 5, 6>, 0>"
  call void @copy_out(%"class.hls::stream<hls::axis<quad_fp_pack, 2, 5, 6>, 0>"* %14, i64* %0, i8* %1, i8* %2, i2* %3, i1* %4, i5* %5, i6* %6, %"class.hls::stream<hls::axis<quad_fp_pack, 2, 5, 6>, 0>"* %15, i64* %7, i8* %8, i8* %9, i2* %10, i1* %11, i5* %12, i6* %13)
  call void @yolo_upsamp_top_hw_stub(%"class.hls::stream<hls::axis<quad_fp_pack, 2, 5, 6>, 0>"* %14, %"class.hls::stream<hls::axis<quad_fp_pack, 2, 5, 6>, 0>"* %15)
  call void @copy_in(%"class.hls::stream<hls::axis<quad_fp_pack, 2, 5, 6>, 0>"* %14, i64* %0, i8* %1, i8* %2, i2* %3, i1* %4, i5* %5, i6* %6, %"class.hls::stream<hls::axis<quad_fp_pack, 2, 5, 6>, 0>"* %15, i64* %7, i8* %8, i8* %9, i2* %10, i1* %11, i5* %12, i6* %13)
  ret void
}

declare void @yolo_upsamp_top_hw_stub(%"class.hls::stream<hls::axis<quad_fp_pack, 2, 5, 6>, 0>"*, %"class.hls::stream<hls::axis<quad_fp_pack, 2, 5, 6>, 0>"*)
