...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("inStream_TDATA", 112, hls_in, 0, "axis", "in_data", 1),
	Port_Property("inStream_TVALID", 1, hls_in, 0, "axis", "in_vld", 1),
	Port_Property("inStream_TREADY", 1, hls_out, 0, "axis", "in_acc", 1),
	Port_Property("outStream_TDATA", 112, hls_out, 1, "axis", "out_data", 1),
