; ModuleID = '/home/tony/Desktop/Tiny_YOLO_v3_ZYNQ/code/hls/yolo_conv/yolo_conv_prj/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_yolo_conv_top_ir(%"class.hls::stream<ap_axi_fp<64, 2, 5, 6>, 0>"* noalias nocapture nonnull dereferenceable(14) %inStream, %"class.hls::stream<ap_axi_fp<64, 2, 5, 6>, 0>"* noalias nocapture nonnull dereferenceable(14) %outStream, %"struct.ap_uint<6>"* nocapture readonly %output_ch, %"struct.ap_uint<6>"* nocapture readonly %input_ch, %"struct.ap_uint<4>"* nocapture readonly %fold_output_ch, %"struct.ap_uint<4>"* nocapture readonly %fold_input_ch, %"struct.ap_uint<9>"* nocapture readonly %input_h, %"struct.ap_uint<9>"* nocapture readonly %input_w, %"struct.ap_uint<9>"* nocapture readonly %real_input_h, %"struct.ap_uint<3>"* nocapture readonly %fold_win_area) local_unnamed_addr #1 {
entry:
  ...
  call void @apatb_yolo_conv_top_hw(%"class.hls::stream<ap_axi_fp<64, 2, 5, 6>, 0>"* %inStream_copy, %"class.hls::stream<ap_axi_fp<64, 2, 5, 6>, 0>"* %outStream_copy, %"struct.ap_uint<6>"* %output_ch, %"struct.ap_uint<6>"* %input_ch, %"struct.ap_uint<4>"* %fold_output_ch, %"struct.ap_uint<4>"* %fold_input_ch, %"struct.ap_uint<9>"* %input_h, %"struct.ap_uint<9>"* %input_w, %"struct.ap_uint<9>"* %real_input_h, %"struct.ap_uint<3>"* %fold_win_area)
...
declare void @apatb_yolo_conv_top_hw(%"class.hls::stream<ap_axi_fp<64, 2, 5, 6>, 0>"*, %"class.hls::stream<ap_axi_fp<64, 2, 5, 6>, 0>"*, %"struct.ap_uint<6>"*, %"struct.ap_uint<6>"*, %"struct.ap_uint<4>"*, %"struct.ap_uint<4>"*, %"struct.ap_uint<9>"*, %"struct.ap_uint<9>"*, %"struct.ap_uint<9>"*, %"struct.ap_uint<3>"*)
...
define void @yolo_conv_top_hw_stub_wrapper(%"class.hls::stream<ap_axi_fp<64, 2, 5, 6>, 0>"*, %"class.hls::stream<ap_axi_fp<64, 2, 5, 6>, 0>"*, %"struct.ap_uint<6>"*, %"struct.ap_uint<6>"*, %"struct.ap_uint<4>"*, %"struct.ap_uint<4>"*, %"struct.ap_uint<9>"*, %"struct.ap_uint<9>"*, %"struct.ap_uint<9>"*, %"struct.ap_uint<3>"*) #6 {
entry:
  ...
  call void @yolo_conv_top_hw_stub(%"class.hls::stream<ap_axi_fp<64, 2, 5, 6>, 0>"* %0, %"class.hls::stream<ap_axi_fp<64, 2, 5, 6>, 0>"* %1, %"struct.ap_uint<6>"* %2, %"struct.ap_uint<6>"* %3, %"struct.ap_uint<4>"* %4, %"struct.ap_uint<4>"* %5, %"struct.ap_uint<9>"* %6, %"struct.ap_uint<9>"* %7, %"struct.ap_uint<9>"* %8, %"struct.ap_uint<3>"* %9)
...
declare void @yolo_conv_top_hw_stub(%"class.hls::stream<ap_axi_fp<64, 2, 5, 6>, 0>"*, %"class.hls::stream<ap_axi_fp<64, 2, 5, 6>, 0>"*, %"struct.ap_uint<6>"*, %"struct.ap_uint<6>"*, %"struct.ap_uint<4>"*, %"struct.ap_uint<4>"*, %"struct.ap_uint<9>"*, %"struct.ap_uint<9>"*, %"struct.ap_uint<9>"*, %"struct.ap_uint<3>"*)
