...
wire   [8:0] add_ln261_fu_211_p2;
reg   [8:0] add_ln261_reg_375;
...
wire   [8:0] add_ln261_1_fu_250_p2;
...
assign add_ln261_1_fu_250_p2 = (conv_count_read_reg_355 + 9'd2);

assign add_ln261_fu_211_p2 = (ap_port_reg_conv_count + 9'd1);
...
assign zext_ln984_11_fu_255_p1 = add_ln261_1_fu_250_p2;
...
assign zext_ln984_7_fu_217_p1 = add_ln261_reg_375;
