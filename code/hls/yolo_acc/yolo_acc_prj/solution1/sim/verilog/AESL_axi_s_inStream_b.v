...
`define TV_IN_inStream_b_TDATA "../tv/cdatafile/c.yolo_acc_top.autotvin_inStream_b.dat"
...
module AESL_axi_s_inStream_b (
    input clk,
    input reset,
    output [112 - 1:0] TRAN_inStream_b_TDATA,
    ...
    reg [112 - 1:0] inStream_b_TDATA_write_data;
    reg inStream_b_TDATA_read_en;
    wire [112 - 1:0] inStream_b_TDATA_read_data;
    
    fifo #(692228, 112) fifo_inStream_b_TDATA (
        .reset(1'b0),
        .write_clock(clk),
    ...
    assign TRAN_inStream_b_TVALID_temp = ~(inStream_b_TDATA_empty);
