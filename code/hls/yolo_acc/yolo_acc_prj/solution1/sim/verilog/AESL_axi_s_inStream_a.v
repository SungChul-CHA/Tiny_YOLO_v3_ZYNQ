...
`define TV_IN_inStream_a_TDATA "../tv/cdatafile/c.yolo_acc_top.autotvin_inStream_a.dat"
...
module AESL_axi_s_inStream_a (
    input clk,
    input reset,
    output [112 - 1:0] TRAN_inStream_a_TDATA,
    ...
    reg [112 - 1:0] inStream_a_TDATA_write_data;
    reg inStream_a_TDATA_read_en;
    wire [112 - 1:0] inStream_a_TDATA_read_data;
    
    fifo #(692224, 112) fifo_inStream_a_TDATA (
        .reset(1'b0),
        .write_clock(clk),
    ...
    assign TRAN_inStream_a_TVALID_temp = ~(inStream_a_TDATA_empty);
