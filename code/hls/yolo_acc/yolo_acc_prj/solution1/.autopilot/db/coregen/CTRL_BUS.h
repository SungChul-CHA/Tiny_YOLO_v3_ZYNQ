...
#define CTRL_BUS_ADDR_INPUT_H_DATA       0x10
#define CTRL_BUS_BITS_INPUT_H_DATA       9
#define CTRL_BUS_ADDR_INPUT_W_DATA       0x18
#define CTRL_BUS_BITS_INPUT_W_DATA       9
#define CTRL_BUS_ADDR_FOLD_INPUT_CH_DATA 0x20
#define CTRL_BUS_BITS_FOLD_INPUT_CH_DATA 4
#define CTRL_BUS_ADDR_LEAKY_DATA         0x28
#define CTRL_BUS_BITS_LEAKY_DATA         1
#define CTRL_BUS_ADDR_BIAS_EN_DATA       0x30
#define CTRL_BUS_BITS_BIAS_EN_DATA       1
