...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("inStream_a_TDATA", 112, hls_in, 0, "axis", "in_data", 1),
	Port_Property("inStream_a_TVALID", 1, hls_in, 0, "axis", "in_vld", 1),
	Port_Property("inStream_a_TREADY", 1, hls_out, 0, "axis", "in_acc", 1),
	Port_Property("inStream_b_TDATA", 112, hls_in, 1, "axis", "in_data", 1),
	Port_Property("inStream_b_TVALID", 1, hls_in, 1, "axis", "in_vld", 1),
	Port_Property("inStream_b_TREADY", 1, hls_out, 1, "axis", "in_acc", 1),
	Port_Property("outStream_TDATA", 112, hls_out, 2, "axis", "out_data", 1),
	Port_Property("outStream_TVALID", 1, hls_out, 2, "axis", "out_vld", 1),
	Port_Property("outStream_TREADY", 1, hls_in, 2, "axis", "out_acc", 1),
