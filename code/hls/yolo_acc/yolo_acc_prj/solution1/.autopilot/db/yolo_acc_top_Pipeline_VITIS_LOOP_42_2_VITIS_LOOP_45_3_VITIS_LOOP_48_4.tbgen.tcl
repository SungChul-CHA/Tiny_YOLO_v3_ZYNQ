...
set C_modelArgList {
	...
	{ sub_i_i54 int 10 regular  }
	{ bound4 int 22 regular  }
	{ bound int 13 regular  }
	{ cmp_i_i31_mid111 int 1 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "sub_i_i", "interface" : "wire", "bitwidth" : 10, "direction" : "READONLY"} , 
 	{ "Name" : "sub_i_i54", "interface" : "wire", "bitwidth" : 10, "direction" : "READONLY"} , 
 	{ "Name" : "bound4", "interface" : "wire", "bitwidth" : 22, "direction" : "READONLY"} , 
 	{ "Name" : "bound", "interface" : "wire", "bitwidth" : 13, "direction" : "READONLY"} , 
 	{ "Name" : "cmp_i_i31_mid111", "interface" : "wire", "bitwidth" : 1, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ outStream_TREADY sc_in sc_logic 1 outacc 12 } 
	{ sub_i_i sc_in sc_lv 10 signal 0 } 
	{ sub_i_i54 sc_in sc_lv 10 signal 1 } 
	{ bound4 sc_in sc_lv 22 signal 2 } 
	{ bound sc_in sc_lv 13 signal 3 } 
	{ cmp_i_i31_mid111 sc_in sc_lv 1 signal 4 } 
	{ fold_input_ch sc_in sc_lv 4 signal 5 } 
	{ icmp_ln1027 sc_in sc_lv 1 signal 6 } 
	{ inStream_a_TDATA sc_in sc_lv 112 signal 7 } 
	{ inStream_a_TVALID sc_in sc_logic 1 invld 7 } 
	{ inStream_a_TREADY sc_out sc_logic 1 inacc 7 } 
	{ inStream_b_TDATA sc_in sc_lv 112 signal 8 } 
	{ inStream_b_TVALID sc_in sc_logic 1 invld 8 } 
	{ inStream_b_TREADY sc_out sc_logic 1 inacc 8 } 
	{ kernel_bias_fp_V_address0 sc_out sc_lv 5 signal 9 } 
	{ kernel_bias_fp_V_ce0 sc_out sc_logic 1 signal 9 } 
	{ kernel_bias_fp_V_q0 sc_in sc_lv 16 signal 9 } 
	{ kernel_bias_fp_V_address1 sc_out sc_lv 5 signal 9 } 
	{ kernel_bias_fp_V_ce1 sc_out sc_logic 1 signal 9 } 
	{ kernel_bias_fp_V_q1 sc_in sc_lv 16 signal 9 } 
	{ bias_en sc_in sc_lv 1 signal 10 } 
	{ leaky sc_in sc_lv 1 signal 11 } 
	{ outStream_TDATA sc_out sc_lv 112 signal 12 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sub_i_i54", "direction": "in", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "sub_i_i54", "role": "default" }} , 
 	...
 	{ "name": "cmp_i_i31_mid111", "direction": "in", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "cmp_i_i31_mid111", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_post_process_unit_fu_286", "Parent" : "0", "Child" : ["2"],
		...
		"Port" : [
			...
			{"Name" : "bias_en", "Type" : "None", "Direction" : "I"},
			{"Name" : "leaky", "Type" : "None", "Direction" : "I"}]},
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_post_process_unit_fu_286.mul_mul_16s_5ns_22_4_0_U5", "Parent" : "1"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_post_process_unit_fu_294", "Parent" : "0", "Child" : ["4"],
		"CDFG" : "post_process_unit",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "0", "ap_start" : "0", "ap_ready" : "0", "ap_done" : "0", "ap_continue" : "0", "ap_idle" : "0", "real_start" : "0",
		"Pipeline" : "Aligned", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		...
		"Port" : [
			...
			{"Name" : "bias_en", "Type" : "None", "Direction" : "I"},
			{"Name" : "leaky", "Type" : "None", "Direction" : "I"}]},
	{"ID" : "4", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_post_process_unit_fu_294.mul_mul_16s_5ns_22_4_0_U5", "Parent" : "3"},
...
set Spec2ImplPortList { 
	...
	sub_i_i54 { ap_none {  { sub_i_i54 in_data 0 10 } } }
	bound4 { ap_none {  { bound4 in_data 0 22 } } }
	bound { ap_none {  { bound in_data 0 13 } } }
	cmp_i_i31_mid111 { ap_none {  { cmp_i_i31_mid111 in_data 0 1 } } }
