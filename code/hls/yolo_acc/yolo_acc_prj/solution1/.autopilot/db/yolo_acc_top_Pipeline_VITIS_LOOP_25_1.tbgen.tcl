...
set portList { 
	...
	{ inStream_b_TDATA sc_in sc_lv 112 signal 3 } 
	{ inStream_b_TREADY sc_out sc_logic 1 inacc 3 } 
}
set NewPortList {[ 
...
set Spec2ImplPortList { 
	...
	inStream_b { axis {  { inStream_b_TVALID in_vld 0 1 }  { inStream_b_TDATA in_data 0 112 }  { inStream_b_TREADY in_acc 1 1 } } }
}
