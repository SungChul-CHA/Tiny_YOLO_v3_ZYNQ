...
set name yolo_yolo_top_mul_5ns_8ns_13_1_1
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler yolo_yolo_top_CTRL_BUS_s_axi BINDTYPE interface TYPE interface_s_axilite
}
...
# RegSlice definition:
set ID 50
set RegSliceName yolo_yolo_top_regslice_both
set RegSliceInstName yolo_yolo_top_regslice_both_U
set CoreName ap_simcore_yolo_yolo_top_regslice_both
if {${::AESL::PGuard_rtl_comp_handler}} {
