...
define void @apatb_yolo_yolo_top_ir(%"class.hls::stream<ap_axi_fp<64, 2, 5, 6>, 0>"* noalias nocapture nonnull dereferenceable(14) %inStream, %"class.hls::stream<ap_axi_fp<64, 2, 5, 6>, 0>"* noalias nocapture nonnull dereferenceable(14) %outStream, %"struct.ap_uint<32>"* nocapture readonly %activate_en, %"struct.ap_uint<5>"* nocapture readonly %input_h, %"struct.ap_uint<5>"* nocapture readonly %input_w) local_unnamed_addr #1 {
entry:
  ...
  call void @apatb_yolo_yolo_top_hw(%"class.hls::stream<ap_axi_fp<64, 2, 5, 6>, 0>"* %inStream_copy, %"class.hls::stream<ap_axi_fp<64, 2, 5, 6>, 0>"* %outStream_copy, %"struct.ap_uint<32>"* %activate_en, %"struct.ap_uint<5>"* %input_h, %"struct.ap_uint<5>"* %input_w)
...
declare void @apatb_yolo_yolo_top_hw(%"class.hls::stream<ap_axi_fp<64, 2, 5, 6>, 0>"*, %"class.hls::stream<ap_axi_fp<64, 2, 5, 6>, 0>"*, %"struct.ap_uint<32>"*, %"struct.ap_uint<5>"*, %"struct.ap_uint<5>"*)
...
define void @yolo_yolo_top_hw_stub_wrapper(%"class.hls::stream<ap_axi_fp<64, 2, 5, 6>, 0>"*, %"class.hls::stream<ap_axi_fp<64, 2, 5, 6>, 0>"*, %"struct.ap_uint<32>"*, %"struct.ap_uint<5>"*, %"struct.ap_uint<5>"*) #6 {
entry:
  ...
  call void @yolo_yolo_top_hw_stub(%"class.hls::stream<ap_axi_fp<64, 2, 5, 6>, 0>"* %0, %"class.hls::stream<ap_axi_fp<64, 2, 5, 6>, 0>"* %1, %"struct.ap_uint<32>"* %2, %"struct.ap_uint<5>"* %3, %"struct.ap_uint<5>"* %4)
...
declare void @yolo_yolo_top_hw_stub(%"class.hls::stream<ap_axi_fp<64, 2, 5, 6>, 0>"*, %"class.hls::stream<ap_axi_fp<64, 2, 5, 6>, 0>"*, %"struct.ap_uint<32>"*, %"struct.ap_uint<5>"*, %"struct.ap_uint<5>"*)
