...
void XYolo_acc_top_Set_input_h(XYolo_acc_top *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XYolo_acc_top_WriteReg(InstancePtr->Ctrl_bus_BaseAddress, XYOLO_ACC_TOP_CTRL_BUS_ADDR_INPUT_H_DATA, Data);
}

u32 XYolo_acc_top_Get_input_h(XYolo_acc_top *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XYolo_acc_top_ReadReg(InstancePtr->Ctrl_bus_BaseAddress, XYOLO_ACC_TOP_CTRL_BUS_ADDR_INPUT_H_DATA);
    return Data;
}

void XYolo_acc_top_Set_input_w(XYolo_acc_top *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XYolo_acc_top_WriteReg(InstancePtr->Ctrl_bus_BaseAddress, XYOLO_ACC_TOP_CTRL_BUS_ADDR_INPUT_W_DATA, Data);
}

u32 XYolo_acc_top_Get_input_w(XYolo_acc_top *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XYolo_acc_top_ReadReg(InstancePtr->Ctrl_bus_BaseAddress, XYOLO_ACC_TOP_CTRL_BUS_ADDR_INPUT_W_DATA);
    return Data;
}

void XYolo_acc_top_Set_fold_input_ch(XYolo_acc_top *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XYolo_acc_top_WriteReg(InstancePtr->Ctrl_bus_BaseAddress, XYOLO_ACC_TOP_CTRL_BUS_ADDR_FOLD_INPUT_CH_DATA, Data);
}

u32 XYolo_acc_top_Get_fold_input_ch(XYolo_acc_top *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XYolo_acc_top_ReadReg(InstancePtr->Ctrl_bus_BaseAddress, XYOLO_ACC_TOP_CTRL_BUS_ADDR_FOLD_INPUT_CH_DATA);
    return Data;
}

void XYolo_acc_top_Set_leaky(XYolo_acc_top *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XYolo_acc_top_WriteReg(InstancePtr->Ctrl_bus_BaseAddress, XYOLO_ACC_TOP_CTRL_BUS_ADDR_LEAKY_DATA, Data);
}

u32 XYolo_acc_top_Get_leaky(XYolo_acc_top *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XYolo_acc_top_ReadReg(InstancePtr->Ctrl_bus_BaseAddress, XYOLO_ACC_TOP_CTRL_BUS_ADDR_LEAKY_DATA);
    return Data;
}

void XYolo_acc_top_Set_bias_en(XYolo_acc_top *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XYolo_acc_top_WriteReg(InstancePtr->Ctrl_bus_BaseAddress, XYOLO_ACC_TOP_CTRL_BUS_ADDR_BIAS_EN_DATA, Data);
}

u32 XYolo_acc_top_Get_bias_en(XYolo_acc_top *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XYolo_acc_top_ReadReg(InstancePtr->Ctrl_bus_BaseAddress, XYOLO_ACC_TOP_CTRL_BUS_ADDR_BIAS_EN_DATA);
    return Data;
}
