...
void XYolo_max_pool_top_Set_output_h(XYolo_max_pool_top *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XYolo_max_pool_top_WriteReg(InstancePtr->Ctrl_bus_BaseAddress, XYOLO_MAX_POOL_TOP_CTRL_BUS_ADDR_OUTPUT_H_DATA, Data);
}

u32 XYolo_max_pool_top_Get_output_h(XYolo_max_pool_top *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XYolo_max_pool_top_ReadReg(InstancePtr->Ctrl_bus_BaseAddress, XYOLO_MAX_POOL_TOP_CTRL_BUS_ADDR_OUTPUT_H_DATA);
    return Data;
}

void XYolo_max_pool_top_Set_output_w(XYolo_max_pool_top *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XYolo_max_pool_top_WriteReg(InstancePtr->Ctrl_bus_BaseAddress, XYOLO_MAX_POOL_TOP_CTRL_BUS_ADDR_OUTPUT_W_DATA, Data);
}

u32 XYolo_max_pool_top_Get_output_w(XYolo_max_pool_top *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XYolo_max_pool_top_ReadReg(InstancePtr->Ctrl_bus_BaseAddress, XYOLO_MAX_POOL_TOP_CTRL_BUS_ADDR_OUTPUT_W_DATA);
    return Data;
}

void XYolo_max_pool_top_Set_input_h(XYolo_max_pool_top *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XYolo_max_pool_top_WriteReg(InstancePtr->Ctrl_bus_BaseAddress, XYOLO_MAX_POOL_TOP_CTRL_BUS_ADDR_INPUT_H_DATA, Data);
}

u32 XYolo_max_pool_top_Get_input_h(XYolo_max_pool_top *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XYolo_max_pool_top_ReadReg(InstancePtr->Ctrl_bus_BaseAddress, XYOLO_MAX_POOL_TOP_CTRL_BUS_ADDR_INPUT_H_DATA);
    return Data;
}

void XYolo_max_pool_top_Set_input_w(XYolo_max_pool_top *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XYolo_max_pool_top_WriteReg(InstancePtr->Ctrl_bus_BaseAddress, XYOLO_MAX_POOL_TOP_CTRL_BUS_ADDR_INPUT_W_DATA, Data);
}

u32 XYolo_max_pool_top_Get_input_w(XYolo_max_pool_top *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XYolo_max_pool_top_ReadReg(InstancePtr->Ctrl_bus_BaseAddress, XYOLO_MAX_POOL_TOP_CTRL_BUS_ADDR_INPUT_W_DATA);
    return Data;
}

void XYolo_max_pool_top_Set_input_fold_ch(XYolo_max_pool_top *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XYolo_max_pool_top_WriteReg(InstancePtr->Ctrl_bus_BaseAddress, XYOLO_MAX_POOL_TOP_CTRL_BUS_ADDR_INPUT_FOLD_CH_DATA, Data);
}

u32 XYolo_max_pool_top_Get_input_fold_ch(XYolo_max_pool_top *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XYolo_max_pool_top_ReadReg(InstancePtr->Ctrl_bus_BaseAddress, XYOLO_MAX_POOL_TOP_CTRL_BUS_ADDR_INPUT_FOLD_CH_DATA);
    return Data;
}

void XYolo_max_pool_top_Set_stride(XYolo_max_pool_top *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XYolo_max_pool_top_WriteReg(InstancePtr->Ctrl_bus_BaseAddress, XYOLO_MAX_POOL_TOP_CTRL_BUS_ADDR_STRIDE_DATA, Data);
}

u32 XYolo_max_pool_top_Get_stride(XYolo_max_pool_top *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XYolo_max_pool_top_ReadReg(InstancePtr->Ctrl_bus_BaseAddress, XYOLO_MAX_POOL_TOP_CTRL_BUS_ADDR_STRIDE_DATA);
    return Data;
}
